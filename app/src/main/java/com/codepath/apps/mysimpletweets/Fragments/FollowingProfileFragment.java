 ...
 */
public class FollowingProfileFragment extends FollowProfileFragment {
    private TwitterClient client;
    private final static String TAG = "Following fragment";
    ...
    public static FollowingProfileFragment newInstance(String screenName, boolean insertAtTop) {
        FollowingProfileFragment followingFragment = new FollowingProfileFragment();
    ...
    public void populateFollowing() {
        ...
        client.getFollowingList(new JsonHttpResponseHandler() {
